...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const r=document.querySelector("input"),o=document.querySelector("textarea"),a=document.querySelector(".feedback-form");a.addEventListener("input",(0,e.default)(c,500)),a.addEventListener("submit",l);const n="feedback-form-state";let u={};function c(e){u[e.target.name]=e.target.value,localStorage.setItem(n,JSON.stringify(u))}function l(e){e.preventDefault(),e.currentTarget.reset(),localStorage.removeItem(n),console.log(u)}function s(){const e=localStorage.getItem(n);if(e){const t=JSON.parse(e);r.value=t.email,o.value=t.message}}s();
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.75c8bacd.js.map