...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const a=document.querySelector("input"),o=document.querySelector("textarea"),r=document.querySelector(".feedback-form");r.addEventListener("input",(0,e.default)(s,500)),r.addEventListener("submit",c);const l="feedback-form-state",n={email:"",message:""};function s(){n.email=a.value,n.message=o.value,localStorage.setItem(l,JSON.stringify(n))}function u(){const e=localStorage.getItem(l);if(e){const t=JSON.parse(e);a.value=t.email,o.value=t.message}}function c(e){e.preventDefault();const t={email:a.value,message:o.value};console.log("User data:",t),e.currentTarget.reset(),localStorage.removeItem(l)}u();
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.556a546c.js.map