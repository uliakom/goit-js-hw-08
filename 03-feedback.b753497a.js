...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const a=document.querySelector("input"),r=document.querySelector("textarea"),o=document.querySelector(".feedback-form");o.addEventListener("input",(0,e.default)(l,500)),o.addEventListener("submit",c);const n="feedback-form-state",u={email:"",message:""};function l(e){u[e.target.name]=e.target.value,localStorage.setItem(n,JSON.stringify(u))}function s(){const e=localStorage.getItem(n);if(e){const t=JSON.parse(e);a.value=t.email,r.value=t.message}}function c(e){e.preventDefault();const t={email:a.value,message:r.value};console.log("User data:",t),e.currentTarget.reset(),localStorage.removeItem(n)}s();
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.b753497a.js.map