...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const a=document.querySelector("input"),l=document.querySelector("textarea"),r=document.querySelector(".feedback-form");r.addEventListener("input",(0,e.default)(u,500)),r.addEventListener("submit",s);const o="feedback-form-state";let n={};function u(e){const{elements:{email:t,message:a}}=e.currentTarget;n={email:t.value,message:a.value},""!==t.value&&""!==a.value||console.log("Please fill all fields"),localStorage.setItem(o,JSON.stringify(n))}function s(e){e.preventDefault(),e.currentTarget.reset(),localStorage.removeItem(o)}function c(){const e=localStorage.getItem(o);if(e){const t=JSON.parse(e);a.value=t.email,l.value=t.message}}c();
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.a66a7b42.js.map